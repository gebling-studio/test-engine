...
use window::{SURFACE_TEXTURE_FORMAT, Window, image::Image};
...
impl UIBlurPipeline {
    ...
    pub fn blur(&mut self, encoder: &mut CommandEncoder, scene: &TextureView, size: Size<u32>, radius: f32) {
    ...
    pub fn output_bind(&self) -> &BindGroup {
    ...
    pub fn present(&self, pass: &mut wgpu::RenderPass, scene: &TextureView) {
